                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all font-mono"
                                placeholder="0"
                            />
                            <span className="absolute right-3 top-2 text-slate-400 text-sm">Paket</span>
                        </div>
                    </div>
